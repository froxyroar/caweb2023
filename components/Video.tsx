    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://apicyberacademy.cpsrg.org/api/academy-count"
        );
      ...
      <div className="flex justify-center items-center mt-5">
        <div className="rounded-lg p-5">
          <div className="grid grid-flow-col gap-5 text-center auto-cols-max">
            ...
            <div
              className="hidden md:flex flex-col w-52 p-3 gap-3 text-center items-center justify-center font-mono bg-neutral rounded-box text-neutral-content"
              style={{ background: "#f8cdce", color: "#231f20" }}
            >
